...
gain = f2group(vslider("[01] GAIN", -15, -96, +6, 0.1)) : ba.db2linear : si.smoo; 
...
gain = f3group(vslider("[01] GAIN", -15, -96, +6, 0.1)) : ba.db2linear : si.smoo; 
...
gain = f4group(vslider("[01] GAIN", -15, -96, +6, 0.1)) : ba.db2linear : si.smoo; 
...
gain = f5group(vslider("[01] GAIN", -15, -96, +6, 0.1)) : ba.db2linear : si.smoo; 
