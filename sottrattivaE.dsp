...
gain = f2group(vslider("[01] GAIN", +15.8, -96, +18, 0.1)) : ba.db2linear : si.smoo;
...
gain = f3group(vslider("[01] GAIN", -15.4, -96, +20, 0.1)) : ba.db2linear : si.smoo;
...
gain = f4group(vslider("[01] GAIN", 9.9, -96, +12, 0.1)) : ba.db2linear : si.smoo;
...
gain = f5group(vslider("[01] GAIN", 3.3, -96, +6, 0.1)) : ba.db2linear : si.smoo;
